...
public class OutlineAltered : MonoBehaviour
{
    ...
    [ContextMenu("Activate Outline")]
    public void ApplyOutline()
    {
        if (isOutlineApplied) return;

        isOutlineApplied = true;
        StartCoroutine(ApplyOutlineRoutine());
    }
    private IEnumerator ApplyOutlineRoutine()
    {
        ActivateOutline();
        yield return null;
    ...
    private IEnumerator RemoveOutlineRoutine()
    {
        DisableOutline();
        yield return null;
